...
public class BuyingActivity extends AppCompatActivity implements OnItemClick {
            ...
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                ...
                startnow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(seller.isEmpty()){
                            Toast.makeText(BuyingActivity.this, "Please select seller name", Toast.LENGTH_SHORT).show();
                        } else if (wb.isEmpty()){
                            Toast.makeText(BuyingActivity.this, "Please enter what are you buying?", Toast.LENGTH_SHORT).show();
                        } else if (prices.isEmpty()){
                            Toast.makeText(BuyingActivity.this, "Please enter the price", Toast.LENGTH_SHORT).show();
                        } else if (descrip.isEmpty()){
                            Toast.makeText(BuyingActivity.this, "Please enter the description", Toast.LENGTH_SHORT).show();
                        } else if (shipcost.isEmpty()){
                            Toast.makeText(BuyingActivity.this, "Please enter shipping cost", Toast.LENGTH_SHORT).show();
                        } else {
                            transactiondata.child("Buying").child(created).child(carid).child("Buyer Name").setValue(created);
                            transactiondata.child("Buying").child(created).child(carid).child("Seller Name").setValue(mSearchField.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("What are you buying?").setValue(wayb.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Price").setValue(price.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Description").setValue(description.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Who will pay for PlaySafe Fee?").setValue(radio1.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Shipping Method").setValue(radio2.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Who will pay for the shipping?").setValue(radio3.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Shipping Cost").setValue(sc.getText().toString());
                            transactiondata.child("Buying").child(created).child(carid).child("Transaction Number").setValue(carid);
                        ...
                        try {
                            ...
                            uploadTask.addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    // ...
                                    Toast.makeText(BuyingActivity.this, "Upload Done", Toast.LENGTH_SHORT).show();
                        ...
                        Intent buyintent = new Intent(BuyingActivity.this, MainActivity.class);
    ...
    private void setAdapter(final String searchedstring) {
        ...
        mUserDatabase.child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                searchAdapter = new SearchAdapter(BuyingActivity.this, nameList, profilePicList, usernameList);
